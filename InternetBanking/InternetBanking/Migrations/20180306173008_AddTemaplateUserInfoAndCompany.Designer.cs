...
namespace InternetBanking.Migrations
{
    ...
    [Migration("20180306173008_AddTemaplateUserInfoAndCompany")]
    partial class AddTemaplateUserInfoAndCompany
    {
            ...
            modelBuilder.Entity("InternetBanking.Models.Template", b =>
                {
                    ...
                    b.Property<int?>("InterBankTransferId");
                    ...
                    b.HasIndex("InterBankTransferId");
            ...
            modelBuilder.Entity("InternetBanking.Models.Template", b =>
                {
                    ...
                    b.HasOne("InternetBanking.Models.InnerTransfer", "InnerTransfer")
                        .WithMany()
                        .HasForeignKey("InnerTransferId");

                    b.HasOne("InternetBanking.Models.InterBankTransfer", "InterBankTransfer")
                        .WithMany()
                        .HasForeignKey("InterBankTransferId");
