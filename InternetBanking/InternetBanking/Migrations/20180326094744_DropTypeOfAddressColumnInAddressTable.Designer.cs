...
namespace InternetBanking.Migrations
{
    ...
    [Migration("20180326094744_DropTypeOfAddressColumnInAddressTable")]
    partial class DropTypeOfAddressColumnInAddressTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InternetBanking.Models.AddressType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("InternetBanking.Models.DocumentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int?>("TypeOfTransferId");

                    b.HasKey("Id");

                    b.HasIndex("TypeOfTransferId");
            ...
            modelBuilder.Entity("InternetBanking.Models.IntervalType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<int>("IntervalCode");

                    b.Property<string>("IntervalName");

                    b.HasKey("Id");

                    b.ToTable("IntervalTypes");
                });
            ...
            modelBuilder.Entity("InternetBanking.Models.PaymentSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<int>("DeferredPaymentCounter");
            ...
            modelBuilder.Entity("InternetBanking.Models.SelectTable.TypeOfTransfer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("TypeOfTransfers");
                });

            modelBuilder.Entity("InternetBanking.Models.Template", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("TemplateDiscription");
            ...
            modelBuilder.Entity("InternetBanking.Models.Address", b =>
                {
                    b.HasOne("InternetBanking.Models.AddressType", "AddressType")
                        .WithMany()
            ...
            modelBuilder.Entity("InternetBanking.Models.DocumentType", b =>
                {
                    b.HasOne("InternetBanking.Models.SelectTable.TypeOfTransfer", "TypeOfTransfer")
                        .WithMany()
                        .HasForeignKey("TypeOfTransferId");
                });
            ...
            modelBuilder.Entity("InternetBanking.Models.PaymentSchedule", b =>
                {
                    b.HasOne("InternetBanking.Models.IntervalType", "IntervalType")
                        .WithMany()
                        .HasForeignKey("IntervalTypeId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("InternetBanking.Models.Template", "Template")
                        .WithMany()
            ...
            modelBuilder.Entity("InternetBanking.Models.Template", b =>
                {
                    ...
                    b.HasOne("InternetBanking.Models.SelectTable.TypeOfTransfer", "Type")
                        .WithMany()
                        .HasForeignKey("TypeOfTransferId");
